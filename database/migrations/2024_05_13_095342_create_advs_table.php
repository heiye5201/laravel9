...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('advs', function (Blueprint $table) {
            ...
            $table->string('url', 150)->nullable()->default('')->comment('链接');
            ...
            $table->unsignedTinyInteger('is_sort')->nullable()->default(0)->comment('排序');
            $table->unsignedTinyInteger('is_type')->nullable()->default(0)->comment('类型');
