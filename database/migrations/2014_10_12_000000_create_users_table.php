...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->rememberToken();
            $table->decimal('money', 8, 2)->nullable()->default(0)->comment('钱包金额');
            $table->decimal('frozen_money', 8, 2)->nullable()->default(0)->comment('冻结金额');
            $table->decimal('integral', 8, 2)->nullable()->default(0)->comment('积分');
