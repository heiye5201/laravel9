...
Route::namespace('Api')->name('api.')->group(function ($route) {
    ...
    $route->get('/app/produce/message', 'KafkaController@produceMessage')->name('produceMessage');
    $route->get('/app/consume/message', 'KafkaController@consumeMessage')->name('consumeMessage');
    $route->get('/app/consume/test', 'KafkaController@consumeTest')->name('consumeTest');

    $route->get('/app/swoole/increment', 'SwooleController@increment')->name('swooleIncrement');
