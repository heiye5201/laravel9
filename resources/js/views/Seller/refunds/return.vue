                    ...
                    <el-form label-position="right" :label-width="'70px'">
                        <el-row :gutter="20" >
                            ...
                            <el-col :span="12" v-if="data.order[k].refund.refund_verify == 1 && data.order[k].refund.refund_step>=1">
                                <el-form-item :label="$t('seller.refunds.user_delivery_no')">{{data.order[k].refund.delivery_no||'-'}}</el-form-item>
                            </el-col>
                            <el-col :span="12" v-if="data.order[k].refund.refund_verify == 1 && data.order[k].refund.refund_step>=1">
                                <el-form-item :label="$t('seller.refunds.re_delivery_no')"><el-input  v-model="data.order[k].refund.re_delivery_no" placeholder="275811554411" /></el-form-item>
                            </el-col>
                            <el-col :span="24">
...
export default {
    ...
    setup(props) {
        ...
        const options = reactive([
            ...
            {label:proxy.$t('seller.refunds.refund_status_cn'),value:'refund_status_cn',type:'tags'},
