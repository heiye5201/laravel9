            ...
            <template #table_add_hook="{dialogParams}">
                <div class="table_add_hook_block">
                    <el-form ref="addForm" label-position="right" :model="dialogParam.addForm" :rules="dialogParam.rules" label-width="120px">
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item :label="$t('seller.goods_attrs.attrs_name')" prop="name"><el-input v-model="dialogParam.addForm.name" /></el-form-item>
                            </el-col>
                            <el-col :span="24">
                                <el-form-item :label="$t('seller.goods_attrs.attrs')" prop="specs">
...
export default {
    ...
    setup(props) {
        ...
        const options = reactive([
            {label:proxy.$t('seller.goods_attrs.attrs_name'),value:'name'},
            {label:proxy.$t('seller.goods_attrs.specs'),value:'specs',type:"tags_array"},
