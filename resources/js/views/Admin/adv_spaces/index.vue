...
export default {
    ...
    setup(props) {
        ...
        const addColumn = [
            ...
            {label:'位置类型',value:'local_type',type:'select',viewType:'dict_tags'},
        ...
        const dialogParam = reactive({
            ...
            dictData:{
                local_type:[{label:'首页banner',value:'home_banner'},{label:'分类banner',value:'class_banner'},{label:'移动banner',value:'wap_banner'}],
            },
