<template>
    <div class="qwit">
        <table-view :options="options" :btnConfig="btnConfigs" :params="params" :dialogParam="dialogParam" :searchOption="searchOptions"  :handleWidth="210">
...
export default {
    ...
    setup(props) {
        ...
        const searchOptions = reactive([
          {label:'店铺名称',value:'filter[store_name]',where:''},
        ])
