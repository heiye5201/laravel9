        ...
        <div class="store_info_block w1200">
            <div class="left_item">
                <div class="store_info">
                    ...
                    <div class="rate">
                        <span style="float:left;padding-top:2px;margin-right:10px">{{$t('home.goods.synthetical_score')}}</span>
                        <el-rate class="rate_class" v-model="data.rate_info.scoreAll"  :score-template="'{value} '+$t('home.store.score')" text-color="#F7BA2A" show-score disabled />
                        <div class="clear"></div>
                    </div>
                    <div class="store_rate">
                        ...
                        <div class="item">
                            ...
                            <el-rate class="rate_class other" v-model="data.rate_info.agreeAll"  :score-template="'{value} '+$t('home.store.score')" text-color="#F7BA2A" show-score disabled />
                            <div class="clear"></div>
                        </div>
                        <div class="item">
                            <span style="float:left;padding-top:2px;margin-right:10px;line-height:32px">{{$t('home.goods.service_score')}}</span>
                            <el-rate class="rate_class other" v-model="data.rate_info.serviceAll"  :score-template="'{value} '+$t('home.store.score')" text-color="#F7BA2A" show-score disabled />
                            <div class="clear"></div>
                        </div>
                        <div class="item">
                            <span style="float:left;padding-top:2px;margin-right:10px;line-height:32px">{{$t('home.goods.delivery_speed')}}</span>
                            <el-rate class="rate_class other" v-model="data.rate_info.speedAll" :score-template="'{value} '+$t('home.store.score')" text-color="#F7BA2A" show-score  disabled />
                            <div class="clear"></div>
                        </div>
                    </div>
                    ...
                    <div class="btn">
                        <span :class="isFav?'navstore':''"  @click="storeFav()">{{isFav?$t('home.store.collected'):$t('home.store.collected_shop')}}</span>
