        ...
        <div class="index_bg">
            <div class="goods_class_list w1200" v-for="(v,k) in data.goods" :key="k">
                ...
                <div v-if="v.goods && v.goods.length>0">
                    ...
                    <div class="index_adv_goods_left"><el-image lazy fit="cover" :src="(v.classLeftAdv && v.classLeftAdv)?v.classLeftAdv:require('@/assets/Home/pc_class_btadv.jpg').default" :alt="v.name" /></div>
...
export default {
    ...
    setup(props) {
        ...
        onMounted( async ()=>{
            ...
            data.adv = resp.adv
            data.classAdv = resp.class_adv
            data.brand = resp.brand
        })
        const toGoods = (e)=>{
            _push('/goods/'+e)
        }
        ...
        return {data,brandChange,toGoods}
    }
}
</script>
