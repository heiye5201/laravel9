<template>
    <div class="user_main table_lists">
        <div class="block_title">
            {{$t('user_center.order.common.index')}}
        </div>
        <div class="x20"></div>
        <el-form class="el_form" v-if="dialogParams.add && dialogParams.add.column.length>0" ref="addForm" label-position="right" :rules="dialogParams.rules||null" :model="formData" :label-width="dialogParams.labelWidth" :fullscreen="dialogParams.fullscreen">
            <el-row :gutter="20">
                ...
                <el-col :span="24"><div class="table-form-content-rate">
                    <el-form-item :label="$t('user_center.order.common.upload_image')" prop="image">
                        <el-upload
                ...
                <el-col :span="24"><div class="table-form-content-rate">
                    <el-form-item :label="$t('user_center.comments.synthesize_score')" prop="score">
                        <el-rate v-model="formData.score" :score-template="'{value} '+$t('home.store.score')" text-color="#F7BA2A" show-score />
                    </el-form-item>
                </div></el-col>
                <el-col :span="24"><div class="table-form-content-rate">
                    <el-form-item :label="$t('user_center.comments.description_match')" prop="agree">
                        <el-rate v-model="formData.agree" :score-template="'{value} '+$t('home.store.score')" text-color="#F7BA2A" show-score />
                    </el-form-item>
                </div></el-col>
                <el-col :span="24"><div class="table-form-content-rate">
                    <el-form-item :label="$t('user_center.comments.service_state')" prop="service">
                        <el-rate v-model="formData.service" :score-template="'{value} '+$t('home.store.score')" text-color="#F7BA2A" show-score />
                    </el-form-item>
                </div></el-col>
                <el-col :span="24"><div class="table-form-content-rate">
                    <el-form-item :label="$t('user_center.comments.delivery_speed')" prop="speed">
                        <el-rate v-model="formData.speed" :score-template="'{value} '+$t('home.store.score')" text-color="#F7BA2A" show-score />
                    </el-form-item>
                </div></el-col>
            </el-row>
...
export default {
    ...
    setup(props) {
        ...
        // 表单配置
        const addColumn = [
             {label:proxy.$t('user_center.order.common.desc'),value:'content',type:'textarea'},
        ]
