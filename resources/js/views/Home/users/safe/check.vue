...
export default {
    ...
    setup(props) {
        ...
        // 表单配置
        const addColumn = [
             {label:proxy.$t('user_center.safe.user_info'),value:'name'},
             {label:proxy.$t('user_center.safe.id_number'),value:'card_no'},
             {label:proxy.$t('user_center.safe.id_number_up'),value:'card_t',type:'image'},
             {label:proxy.$t('user_center.safe.id_number_down'),value:'card_b',type:'image'},
             {label:proxy.$t('user_center.safe.bank_number'),value:'bank_no'},
             {label:proxy.$t('user_center.safe.bank_name'),value:'bank_name'},
        ]
