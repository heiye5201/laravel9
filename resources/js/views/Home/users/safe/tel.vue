<template>
    <div class="user_main table_lists">
        <div class="block_title">
            {{$t('user_center.safe.tel.update_tel')}}
        </div>
        <div class="x20"></div>
        <el-form class="el_form" v-if="dialogParams.add && dialogParams.add.column.length>0" ref="addForm" label-position="right" :rules="dialogParams.rules||null" :model="formData" :label-width="dialogParams.labelWidth" :fullscreen="dialogParams.fullscreen">
            <el-row :gutter="20">
                <el-col :span="24">
                    <el-form-item :label="$t('user_center.safe.tel.tel')" >
                ...
                <el-col :span="24">
                    <el-form-item :label="$t('user_center.safe.tel.code')"  :prop="'code'">
...
export default {
    ...
    setup(props) {
        ...
        // 表单配置
        const addColumn = [
             {label:proxy.$t('user_center.safe.tel.new_tel'),value:'phone'},
        ]
