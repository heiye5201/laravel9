<template>
    <div class="user_main table_lists">
        <div class="block_title">
            {{$t('user_center.safe.pay_password')}}
        </div>
        <div class="x20"></div>
...
export default {
    ...
    setup(props) {
        ...
        // 表单配置
        const addColumn = [
             {label:proxy.$t('user_center.safe.new_password'),value:'pay_password',type:'password'},
             {label:proxy.$t('user_center.safe.duplicate_password'),value:'re_pay_password',type:'password'},
        ]
