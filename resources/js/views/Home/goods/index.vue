<template>
    <div class="goods_list_temp">
        <div class="w1200 breadcrumb">
            <el-breadcrumb>
                <el-breadcrumb-item separator="/">{{$t('home.store_index.home_index')}}</el-breadcrumb-item>
                <el-breadcrumb-item v-if="!R.isEmpty(data.base64Decode.keywords)"><em style="color:#ca151e">{{$t("btn.search2")}} "{{decodeURIComponent(data.base64Decode.keywords||'')}}" {{$t('home.goods.result_list')}}</em></el-breadcrumb-item>
                <el-breadcrumb-item v-else>{{$t('home.goods.goods_list')}}</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="goods_where w1200">
            <div class="item">
                <div class="title">{{$t('home.collectives.class')}}：</div>
                <div class="list">
                    <div class="first">
                        <ul>
                            <li :class="(R.isEmpty(data.base64Decode.pid) || data.base64Decode.pid==0)?'red':''" @click="classChange(0,{},3)">{{$t('home.collectives.all')}}</li>
            ...
            <div class="item">
                <div class="title">{{$t('home.collectives.brand_select')}}：</div>
                <div class="list">
                    <div class="first">
                        <ul>
                            <li :class="(R.isEmpty(data.base64Decode.brand_id) || data.base64Decode.brand_id==0)?'red':''" @click="brandChange(0)" >{{$t('home.collectives.all')}}</li>
            ...
            <div class="s_goods_list">
                <div class="item" v-for="(v,k) in data.list" :key="k">
                    <dl><router-link :to="'/goods/'+v.id">
                        ...
                        <dd>
                            <span>{{$t('home.collectives.now_buy')}}</span>
                            <span>{{v.order_comment_count}} {{$t('home.collectives.people')}}{{$t('home.collectives.common')}}</span>
                        </dd></router-link>
                    </dl>
                </div>
                <div class="clear"></div>
