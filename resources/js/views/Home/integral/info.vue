    ...
    <div class="goods_info_temp">
        ...
        <div class="goods_info_top w1200">
            ...
            <div class="goods_info_top_right" >
                <div class="goods_info_title">{{data.goods_info.goods_name||$t('home.loading')}}
                    <p>{{data.goods_info.goods_subname||$t('home.loading')}}</p>
                </div>
                <div class="goods_info_group">
                    <div class="goods_info_price"><span>{{$t('home.integral.point')}}：</span>{{$t('btn.money')}}{{data.goods_info.goods_price||'0.00'}}</div>
                    ...
                    <div class="goods_info_phone_read">{{$t('home.goods.phone_read')}}<i style="font-size:16px" class="fa fa-qrcode"></i></div>
                </div>
                ...
                <div class="goods_info_btn">
                    <div class="goods_info_buy" @click="buy()"><img :src="require('@/assets/Home/buy.png').default" />  {{$t('home.integral.now_buy')}}</div>
                </div>
