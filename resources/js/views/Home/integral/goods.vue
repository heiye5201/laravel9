    ...
    <div class="goods_list_temp">
        <div class="w1200 breadcrumb">
            <el-breadcrumb>
                ...
                <el-breadcrumb-item v-else>{{$t('home.integral.goods')}}</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="goods_where w1200">
            <div class="item">
                ...
                <div class="list">
                    <div class="first">
                        <ul>
                            <li :class="(R.isEmpty(data.base64Decode.cid) || data.base64Decode.cid==0)?'red':''" @click="classChange(0)">{{$t('home.collectives.all')}}</li>
            ...
            <div class="s_goods_list">
                <div class="item" v-for="(v,k) in data.list" :key="k">
                    <dl><router-link :to="'/integral/goods/'+v.id">
                        ...
                        <dd>
                            <span class="integral">{{$t('home.integral.now_buy')}}</span>
                        </dd></router-link>
                    </dl>
                </div>
                <div class="clear"></div>
