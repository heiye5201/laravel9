                ...
                <ul>
                    ...
                    <li>
                        <div class="index_my_car">
                            <span >{{$t('home.store_index.my_shop')}}<i class="fa fa-home" /></span>
                            <span><router-link to="/carts">{{$t('home.store_index.my_cart')}}<el-icon><i class="fa fa-shopping-cart" /></el-icon></router-link><div class="shop_car_dot">{{data.cart||0}}</div></span>
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <div class="shop_top_nav_right">
                    <ul>
                      ...
                      <li>
                        ...
                        <li>
                            <router-link to="/user/article/help_center">{{$t('home.store_index.help_center')}}</router-link>
                        </li>
                    </ul>
                </div>
            </div>
