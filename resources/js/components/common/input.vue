<template>
    <div class="qw_input">
        <q-font v-if="params.type=='icon'" :value="formData" />
        <table-select v-if="params.type=='table_select'" :value="formData" :params="params" @changeVla="cascaderChange" />
        <el-input v-if="params.type=='text' || params.type=='password' || params.type=='number' || params.type==undefined" :type="params.type||'text'" :value="formData" :placeholder="params.placeholder||''"  />
        <el-input v-if="params.type=='textarea'" :type="'textarea'" class="input_textarea" :show-word-limit="params.showWordLimit||true" :maxlength="params.maxlength||15" :value="formData" :placeholder="params.placeholder||''"  />
        <el-cascader @change="cascaderChange"  style="width:100%" v-if="params.type=='cascader'" :value="formData" :options="dictData[params.value]||[]" :props="params.props||{}" :placeholder="params.placeholder||''" />
        <el-cascader @change="cascaderChange"  style="width:100%" v-if="params.type=='cascader_lazy'" :value="formData" :options="dictData[params.value]||[]" :props="params.props||{emitPath:true,label:'name',value:'id',lazy:true,lazyLoad:lazyLoad}" :placeholder="params.placeholder||''" />
        <el-select style="width:100%" v-if="params.type=='select'" :value="formData" :filterable="params.filterable||false" :multiple="params.multiple||false" :placeholder="params.placeholder||''" >
        ...
        <el-autocomplete v-if="params.type=='autocomplete'" :value="formData"  @select="cascaderChange" :fetch-suggestions="querySearch" >
        ...
        <el-switch :value="formData"  v-if="params.type=='switch'" :active-text="params.activeText||$t('btn.yes')" :inactive-text="params.inactiveText||$t('btn.no')" :inline-prompt="params.inlinePrompt||true" />
        <el-radio-group :value="formData" v-if="params.type=='radio'">
        ...
        <el-date-picker v-if="params.type=='datetime'" style="width:100%" type="datetime" value-format="YYYY-MM-DD HH:mm:ss" :placeholder="params.placeholder||''" :value="formData" />
        <el-date-picker v-if="params.type=='date'"  style="width:100%" type="date" value-format="YYYY-MM-DD" :placeholder="params.placeholder||''" :value="formData" />
    </div>
</template>
